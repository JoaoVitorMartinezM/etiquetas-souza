...
export default function Home() {
  return (
    <div className="flex flex-col h-auto">
      <div className="flex p-4 md:px-80 items-end justify-center al h-[400px] bg-[url(/imagem-principal-home.png)] bg-top bg-no-repeat bg-cover md:bg-center">
        <Link href={"/servicos"}>
      ...
      <section className="flex justify-around items-center flex-wrap bg-slate-200 py-8">
        <div className="flex flex-col items-center my-8 w-full p-4 md:w-1/4">
          <Subtitle title="Serviços" />
          <Caption text="Nós temos 12 anos de excelência, estamos prontos para atender a sua necessidade." />
        </div>
        <Carousel className="w-full max-w-xs md:hidden self-center flex justify-center">
          <CarouselContent>
      ...
      <section className="flex flex-col items-start my-8 gap-4 md:w-1/2 mx-auto">
        <Subtitle title="Produtos em Destaque" />
        <div className="flex flex-col gap-4 md:flex-row md:justify-around items-center w-full">
          <Link href={"/produtos"}>
            <Image alt="Etiquetas para alimentos" src='/products/rotulo_alimenticio.png' width={200} height={300} className="md:rounded-full w-full rounded-md" />
            <div className="text-center">
              <Caption text="Rótulos alimentícios." />
            </div>
          </Link>
          <Link href={"/produtos"}>
            <Image alt="Etiquetas BOPP" src='/products/rotulo_bopp.webp' width={200} height={300} className="md:rounded-full w-full rounded-md" />
            <div className="text-center">
              <Caption text="Etiquetas BOPP." />
            </div>
          </Link>
          <Link href={"/produtos"}>
            <Image alt="Etiquetas metalizadas" src='/products/rotulo-metalizado.webp' width={400} height={300} className="md:rounded-full w-80 rounded-md" />
            <div className="text-center">
